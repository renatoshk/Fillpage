...
<div class="row">
            ...
            <div class="col-md-8">
                ...
                <br>
                <span style="color:red">{!!str_limit($post->body), 100!!}</span>
                <br>
                <br>
                <a class="btn btn-primary" href="/post/{{$post->slug}}">Read More <span class="glyphicon glyphicon-chevron-right"></span></a><hr>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <ul class="list-unstyled">
                                ...
                                <li><a href="{{$category->posts}}">{{$category->name}}</a>
                                </li>
                                @endforeach
                                @endif
                            </ul>
